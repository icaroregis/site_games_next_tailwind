                ...
                return (
                  <div
                    ...
                    <div className="w-full flex flex-col gap-2 pl-4">
                      <h2 className="text-3xl text-green-master mb-4">{article.title}</h2>
                      <p className="flex-grow">{article.publishedAt.toISOString()}</p>
                      <p className="flex-grow">{article.excerpt}</p>
                      <button className="bg-slate-700 hover:bg-green-master/50 rounded-lg px-4 py-2 inline max-w-max">
                        Ler mais
                      </button>
                    </div>
                  </div>
